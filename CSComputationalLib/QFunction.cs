...
namespace ComputationLib
{
    public abstract class QFunction
    {
        ...
        protected long _itr = 0;
        protected cStepSizeRule _stepSizeRule;
        protected double[] _minimumX;
        protected double _fAtMinimumX;
        protected int _numOfOptimizationIterations;
        ...
        public double FunctionValueAtMinimumX
        {
            get { return _fAtMinimumX; }
        }
        public int NumOfOptimizationIterations
        {
            get { return _numOfOptimizationIterations; }
        }

        // setup step size rule
        public void SetupAConstantStepSizeRule(double stepSize)
        {
            _stepSizeRule = new cConstantStepSize(_name, stepSize);
            _itr = 0;
        }
        public void SetupAHarmonicStepSizeRule(double a)
        {
            _stepSizeRule = new cHarmonicStepSize(_name, a);
            _itr = 0;
        }
        public void SetupAPolynomialStepSizeRule(double beta)
        {
            _stepSizeRule = new cPolynomialStepSize(_name, beta);
            _itr = 0;
        }

        // L2 regularization
        public virtual void AddL2Regularization(double penaltyParameter)
        {
        }
        // update
        ...
        // function value
        public virtual double fValue(double[] continuousVar)
        {
            return 0;
        }
        public virtual double fValue(int[] indicatorVar, double[] continuousVar)
        {
            return 0;
        }
        // gradient 
        public virtual double[] fGradientValue(double[] inputVariables)
        {
            return null;
        }
        // jacobian
        public virtual double[,] fJacobianValue(double[] var)
        {
            return null;
        }
        // reset Q-function
    ...
    public class PolynomialQFunction : QFunction
    {
        ...
        public override void Update(double[] continuousVar, double fValue, int itr)
        {
            ...
            _leastSquares.Update(ConvertToRowDesign(continuousVar), fValue, _stepSizeRule.ObservationDiscountRate(base._itr));
        }        
        ...
        public override void Update(int[] indicatorVar, double[] continuousVar, double fValue, int itr)
        {
            ...
            //_leastSquares.Update(ConvertToRowDesign(var), fValue, _stepSizeRule.ObservationDiscountRate(itr));
            _leastSquares.Update(ConvertToRowDesign(indicatorVar, continuousVar), fValue, _stepSizeRule.ObservationDiscountRate(base._itr));
        }
        ...
        {            
            ...
            _minimumX = (double[])newVar.Clone();
            _fAtMinimumX = fValue(_minimumX);
            _numOfOptimizationIterations = numOfIterations;
        }
